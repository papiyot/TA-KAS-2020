            ...
            <div class="block-content">
                <table class="table table-bordered table-striped table-hover table-vcenter js-dataTable-full-pagination">
                    ...
                    <tr>
                        ...
                        <th class="d-none d-sm-table-cell" style="width: 15%;">STOK</th>
                        <th class="d-none d-sm-table-cell" style="width: 15%;">SATUAN</th>
                    ...
                    <tr>
                        ...
                        <td>{{$list->barang_harga}}</td>
                        <td class="d-none d-sm-table-cell">{{$list->barang_harga_presentase}}</td>
                        <td class="d-none d-sm-table-cell">{{$list->barang_stok}}</td>
                        <td class="d-none d-sm-table-cell">{{$list->barang_satuan}}</td>
