            ...
            <div class="col-md-8">
                <div class="block block-themed block-rounded">
                    ...
                    <div class="block-content">
                        <form action="{{ route('penjualan.barang_store') }}" method="post" > @csrf
                            <div class="form-group row">
                                    ...
                                    <div class="form-material">
                                        ...
                                        <select onchange="getharga(this, 'jual_detail')" class="js-select2 form-control" id="jual_detail_barang_id" name="jual_detail_barang_id" required style="width: 100%;" >
                                            ...
                                            @foreach($data->barang as $barang)
                                                <option harga="{{$barang->barang_harga}}" value="{{$barang->barang_id}}" @php echo ($data->edit) ? ($data->edit->jual_detail_barang_id == $barang->barang_id) ? 'selected': '' : null; @endphp>{{$barang->barang_id}} [ {{$barang->barang_nama}} ]</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-12 col-sm-6 col-md-6">
                                    <div class="form-material">
                                        <input type="number" class="form-control" id="jual_detail_harga" value="@php echo ($data->edit) ? $data->edit->jual_detail_harga: ''; @endphp" name="jual_detail_harga" required >
                                        <label for="jual_detail_harga">Harga Barang</label>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 col-md-6">
                                    <div class="form-material">
                                        <input type="number" class="form-control" id="jual_detail_jml" value="@php echo ($data->edit) ? $data->edit->jual_detail_jml: ''; @endphp" name="jual_detail_jml" required >
            ...
            <div class="col-md-4">
                ...
                <div class="block block-rounded bg-gd-primary" >
                    ...
                    <div class="block-content block-content-full ">
                        ...
                        <form action="{{ route('jual.store') }}" method="post" > @csrf
                            <input type="hidden" class="form-control" id="jual_id" name="jual_id" >
                            <input type="hidden" class="form-control" id="jual_total" name="jual_total" value="{{$data->total}}">
                        ...
                        @foreach($data->list as $list)
                            <tr>
                                ...
                                <td class="text-center table-secondary">
                                    <div class="btn-group">
                                        <a href="{{ route('jual.transaksi',[$list->jual_detail_id]) }}" class="btn btn-sm btn-secondary js-tooltip-enabled" data-toggle="tooltip" title="" data-original-title="Edit">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <a class="btn btn-sm btn-danger" data-toggle="confirmation" data-popout="true" data-title="Hapus Data ini?"
                                           href="{{ route('penjualan.barang_delete',[$list->jual_detail_id]) }}" ><i class="fa fa-times"></i></a>
                                    </div>
                                </td>
                            </tr>
